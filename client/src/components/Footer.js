...
function Footer() {
    return (
        <footer className='bg-slate-200 text-black-600 flex justify-end flex-col items-center'>
            <Link to={"/"}>
                <div className="logo font-bold text-blue-500 py-3 px-7 cursor-pointer">Demo WebApp</div>
            </Link>
            ...
            <div className="copyright font-bold text-white bg-blue-500 py-2 w-full text-center">Copyrights &copy; Demo WebApp --All rights reserved.</div>
        </footer>
    )
}
